...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('tipocadastro', function (Blueprint $table) {
            Tools::setDatabaseEngine($table);
            $table->bigIncrements('id');
            $table->string('tpcidentificacao', 250)->nullable()->default(null);
            ...
            $table->dateTime('tpcversao')->nullable()->default(null);
        });
    }
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('tipocadastro');
