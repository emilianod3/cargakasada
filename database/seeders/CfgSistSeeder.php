...
class CfgSistSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		CfgSist::create(['fkidconfig' => 9, 'transtatus' => 1, 'valor1' => 'http://127.0.0.1:83/portalmod1', 'valor2' => '', 'tranversao' => Carbon::now()->toDateTimeString(), 'fkidgestor' => $fkidgestorparam, 'flagdelete' => 0, 'flagatualiza' => 1, 'flagcontrole' => 1, 'flaguser' => 0]);
