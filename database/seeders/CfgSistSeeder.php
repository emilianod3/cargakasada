...
class CfgSistSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		CfgSist::create(['fkidconfig' => 29, 'transtatus' => 1, 'valor1' => 'C:\\Python\\Python39\\python.exe', 'valor2' => 'python3.9', 'tranversao' => Carbon::now()->toDateTimeString(), 'fkidgestor' => $fkidgestorparam, 'flagdelete' => 0, 'flagatualiza' => 1, 'flagcontrole' => 1, 'flaguser' => 0]);	
		CfgSist::create(['fkidconfig' => 30, 'transtatus' => 1, 'valor1' => '', 'valor2' => '/home1/ciopge02/.local/lib/python3.9/site-packages', 'tranversao' => Carbon::now()->toDateTimeString(), 'fkidgestor' => $fkidgestorparam, 'flagdelete' => 0, 'flagatualiza' => 1, 'flagcontrole' => 1, 'flaguser' => 0]);	
		CfgSist::create(['fkidconfig' => 31, 'transtatus' => 1, 'valor1' => 'C:\\Program Files\\gs\\gs9.53.3\\bin\\gswin64c.exe', 'valor2' => 'gs', 'tranversao' => Carbon::now()->toDateTimeString(), 'fkidgestor' => $fkidgestorparam, 'flagdelete' => 0, 'flagatualiza' => 1, 'flagcontrole' => 1, 'flaguser' => 0]);
		CfgSist::create(['fkidconfig' => 32, 'transtatus' => 1, 'valor1' => 'qpdf --qdf --object-streams=disable', 'valor2' => 'qpdf --qdf --object-streams=disable', 'tranversao' => Carbon::now()->toDateTimeString(), 'fkidgestor' => $fkidgestorparam, 'flagdelete' => 0, 'flagatualiza' => 1, 'flagcontrole' => 1, 'flaguser' => 0]);
		CfgSist::create(['fkidconfig' => 33, 'transtatus' => 1, 'valor1' => 'python', 'valor2' => '', 'tranversao' => Carbon::now()->toDateTimeString(), 'fkidgestor' => $fkidgestorparam, 'flagdelete' => 0, 'flagatualiza' => 1, 'flagcontrole' => 1, 'flaguser' => 0]);
		CfgSist::create(['fkidconfig' => 34, 'transtatus' => 1, 'valor1' => 'build/assets/icons/assinatura_selo_icp.jpg', 'valor2' => 'build/assets/icons/iconcert32.jpg', 'tranversao' => Carbon::now()->toDateTimeString(), 'fkidgestor' => $fkidgestorparam, 'flagdelete' => 0, 'flagatualiza' => 1, 'flagcontrole' => 1, 'flaguser' => 0]);
		CfgSist::create(['fkidconfig' => 35, 'transtatus' => 1, 'valor1' => 'nao', 'valor2' => '', 'tranversao' => Carbon::now()->toDateTimeString(), 'fkidgestor' => $fkidgestorparam, 'flagdelete' => 0, 'flagatualiza' => 1, 'flagcontrole' => 1, 'flaguser' => 0]);
