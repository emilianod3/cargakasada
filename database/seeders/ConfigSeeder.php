...
class ConfigSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Config::create(['id' => 29, 'identificacao' => 'Exibição de Mensagens de Confirmação', 'exemplo' => 'Exibe Mensagens de Confirmação em Todos os Casos de Interação com a Base de Dados', 'tipodado' => 1, 'status' => 1, 'classificacao' => 2, 'valor1' => 'nao', 'valor2' => '', 'versao' => Carbon::now()->toDateTimeString(), 'flagdelete' => 0, 'flagexibe' => 1, 'flagatualiza' => 1, 'flagcontrole' => 1, 'flaguser' => 0]);
