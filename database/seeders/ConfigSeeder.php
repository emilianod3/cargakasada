...
class ConfigSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Config::create(['id' => 9, 'identificacao' => 'Site vinculado ao sistema', 'exemplo' => 'Site vinculado ao sistema para geraçãoo de atalhos.', 'tipodado' => 2, 'status' => 1, 'classificacao' => 1, 'valor1' => 'http://127.0.0.1:83/portalmod1', 'valor2' => '', 'versao' => Carbon::now()->toDateTimeString(), 'flagdelete' => 0, 'flagexibe' => 1, 'flagatualiza' => 1, 'flagcontrole' => 1, 'flaguser' => 0]);
